...
CURATED: dict[str, dict[str, str]] = {
    "obs_id": {"category": "Identifiers", "pages": "Top 50 Review Queue, Selected Case Review"},
    ...
    "exporter_iso3": {"category": "Identifiers", "pages": "Top 50 Review Queue, Selected Case Review"},
    "importer_iso3": {"category": "Identifiers", "pages": "Top 50 Review Queue, Selected Case Review"},
    ...
    "severity": {"category": "Evidence fields", "pages": "Selected Case Review, Trade Landscape and Patterns"},
