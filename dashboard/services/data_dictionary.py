...
CURATED: dict[str, dict[str, str]] = {
    "obs_id": {"category": "Identifiers", "pages": "Review Queue, Case Investigation"},
    "source_row_id": {"category": "Identifiers"},
    "evidence_id": {"category": "Evidence fields", "pages": "Case Investigation"},
    "corridor_id": {"category": "Identifiers", "pages": "Case Investigation"},
    ...
    "exporter_iso3": {"category": "Identifiers", "pages": "Review Queue, Case Investigation"},
    "importer_iso3": {"category": "Identifiers", "pages": "Review Queue, Case Investigation"},
    ...
    "benchmark_residual": {"category": "Time-safe features", "unit": "log difference",
                           "pages": "Case Investigation, Portfolio Analytics"},
    "shifted_corridor_history_median": {"category": "Time-safe features"},
    "shifted_corridor_history_mad": {"category": "Time-safe features"},
    "robust_historical_z": {"category": "Time-safe features", "pages": "Case Investigation"},
    ...
    "corridor_novelty_flag": {"category": "Time-safe features", "pages": "Case Investigation"},
    "corridor_reactivation_flag": {"category": "Time-safe features", "pages": "Case Investigation"},
    ...
    "data_quality_flags": {"category": "Quality fields", "pages": "Case Investigation"},
    "data_quality_score": {"category": "Quality fields", "unit": "additive score 0–6",
                           "pages": "Review Queue, Case Investigation"},
    "quality_status": {"category": "Quality fields", "pages": "Review Queue, Case Investigation"},
    "model_eligible": {"category": "Quality fields", "pages": "Executive Overview"},
    "valid_extreme_flag": {"category": "Quality fields", "pages": "Case Investigation"},
    "exclusion_reason": {"category": "Quality fields"},
    "rank": {"category": "Model scores", "pages": "Review Queue, Case Investigation"},
    ...
    "key_evidence_count": {"category": "Evidence fields", "pages": "Review Queue, Case Investigation"},
    "evidence_type": {"category": "Evidence fields", "pages": "Case Investigation"},
    "metric_name": {"category": "Evidence fields", "pages": "Case Investigation"},
    "observed_value": {"category": "Evidence fields", "pages": "Case Investigation"},
    "comparison_value": {"category": "Evidence fields", "pages": "Case Investigation"},
    "comparison_group": {"category": "Evidence fields", "pages": "Case Investigation"},
    "threshold": {"category": "Evidence fields", "pages": "Case Investigation"},
    "direction": {"category": "Evidence fields"},
    "severity": {"category": "Evidence fields", "pages": "Case Investigation, Portfolio Analytics"},
    "source_fields": {"category": "Evidence fields"},
    "plain_english_summary": {"category": "Evidence fields", "pages": "Case Investigation"},
    "caveat": {"category": "Evidence fields", "pages": "Case Investigation"},
}
