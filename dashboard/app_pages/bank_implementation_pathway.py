...
st.markdown(
    ...
    '<div class="bip-ai-role">'
    f'<span class="bip-ai-role-icon">{render_icon("brain")}</span>'
    f'<div><div class="bip-ai-role-label">{_e(ai["role_label"])}</div>'
    f'<p>{_e(ai["role_statement"])}</p></div></div>'
    f'{_ai_flow(ai["steps"])}'
    f'{_mockup(ai["mockup"])}'
