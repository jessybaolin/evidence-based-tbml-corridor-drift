...
_PATHS: dict[str, str] = {
    ...
    "youtube": '<rect x="1.5" y="5" width="21" height="14" rx="4" fill="currentColor" stroke="none"/><path d="m10 9 5 3-5 3Z" fill="white" stroke="none"/>',
    "sparkles": '<path d="M12 3l1.7 4.3L18 9l-4.3 1.7L12 15l-1.7-4.3L6 9l4.3-1.7Z"/><path d="M18 14l.8 2.2L21 17l-2.2.8L18 20l-.8-2.2L15 17l2.2-.8Z"/>',
    "users": '<circle cx="9" cy="8" r="3.2"/><path d="M3.6 20c0-3 2.4-5 5.4-5s5.4 2 5.4 5"/><path d="M16 5.2a3.2 3.2 0 0 1 0 5.6M18.6 20c0-2.4-1.1-4.2-2.9-4.8"/>',
    "check": '<path d="M5 13l4 4L19 7"/>',
    "x": '<path d="M6 6l12 12M18 6 6 18"/>',
    "minus": '<path d="M5 12h14"/>',
    "alert-triangle": '<path d="M12 3.5 21 19H3Z"/><path d="M12 10v4M12 17h.01"/>',
